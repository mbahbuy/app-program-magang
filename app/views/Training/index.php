        ...
        if( dataJson == null )
        {
            ...
            xhttp.onload = function()
            {
                ...
                for( let i = 0; i < JSONdata.length; i++ )
                {
                    ...
                    dataArray.innerHTML = "<div class='card-header'>" + JSONdata[i].list + "</div><div class='card-body'><h5 class='card-title'>" + JSONdata[i].name + "</h5><p class='card-text'>" + JSONdata[i].deskripsi + "<img class='img-thumbnail' src='" + JSONdata[i].img + "'></p><a  href='<?= BASEURL;?>training/book/" + JSONdata[i].id + "' class='btn btn-primary'>" + JSONdata[i].harga + "</a></div>";
